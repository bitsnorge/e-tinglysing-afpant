...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    ...
    <html>
      ...
      <body>
        <div id="container">
          ...
          <div id="body">
            <xsl:apply-templates select="FinansieringsbekreftelseForespoersel"/>
            <xsl:apply-templates select="finansieringsbekreftelseAvsluttet"/>
            <xsl:apply-templates select="finansieringsbekreftelseAvsluttetForKjoepere"/>
          </div>
        </div>
  ...
  <xsl:template name="overskrift">
    <xsl:if test="FinansieringsbekreftelseForespoersel">
      <xsl:text>Finansieringsbekreftelse</xsl:text>
    </xsl:if>
    <xsl:if test="finansieringsbekreftelseAvsluttetForKjoepere">
      <xsl:text>FinansieringsbekreftelseAvsluttetForKjoepere</xsl:text>
    </xsl:if>
    <xsl:if test="finansieringsbekreftelseAvsluttet">
      <xsl:text>FinansieringsbekreftelseAvsluttet</xsl:text>
    </xsl:if>
  </xsl:template>
  
  <xsl:template match="/FinansieringsbekreftelseForespoersel">
    <xsl:call-template name="FinansieringsbekreftelseForespoersel-template"/>
  </xsl:template>
  
  <xsl:template match="/finansieringsbekreftelseAvsluttet">
    <xsl:call-template name="finansieringsbekreftelseAvsluttet-template"/>
  </xsl:template>
  
  <xsl:template match="/finansieringsbekreftelseAvsluttetForKjoepere">
    <xsl:call-template name="finansieringsbekreftelseAvsluttetForKjoepere-template"/>
  </xsl:template>
  
  <xsl:template name="FinansieringsbekreftelseForespoersel-template">
    <xsl:call-template name="annen"/>
    <xsl:call-template name="budinformasjon"/>
    <xsl:call-template name="objektstype"/>
    <xsl:call-template name="salgsobjektseksjon" />
  ...
  <xsl:template name="finansieringsbekreftelseAvsluttet-template">
    <div class="hovedseksjon">
      <div class="tabell innhold">
        <div class="kropp">
          <div class="rad headerrad">
            <div class="celle">Referanse</div>
          </div>
          <div class="rad">
  ...
  <xsl:template name="finansieringsbekreftelseAvsluttetForKjoepere-template">
    <xsl:call-template name="annen"/>
    <xsl:call-template name="kjopeinformasjon"/>
    <xsl:call-template name="objektstype"/>
    <xsl:call-template name="salgsobjektseksjon" />
    <xsl:call-template name="megler"/>
    <xsl:call-template name="bank"/>
  ...
  <xsl:template name="annen">
    <div class="hovedseksjon">
      <div class="tabell innhold">
        <div class="kropp">
          <div class="rad headerrad">
            <div class="celle">Referanse</div>
            <div class="celle">Personnnummer</div>
          </div>
          <div class="rad">
            <div class="celle kol1">
              <xsl:value-of select="referanse"/>
  ...
  <xsl:template name="kjopeinformasjon">
    <div class="hovedseksjon">
      <div class="tabell innhold">
        <div class="kropp">
          <div class="rad headerrad">
            <div class="celle">Kjøpebeløp</div>
            <div class="celle">Akseptdato</div>
          </div>
          <div class="rad">
            <div class="celle kol1">
              <xsl:value-of select="format-number(sum(kjoepesum), '0')"/>
              <xsl:text>&#x20;NOK</xsl:text>
            </div>
            <div class="celle" style="min-width:120px;">
              <xsl:value-of select="akseptdato"/>  
            </div>
          </div>
        </div>
      </div>
  ...
  <xsl:template name="budinformasjon">
    <div class="hovedseksjon">
      ...
      <div class="tabell innhold">
        <div class="kropp">
          <div class="rad headerrad">
            <div class="celle">Budbeløp</div>
            <div class="celle">Akseptfrist</div>
          </div>
          <div class="rad">
            <div class="celle kol1">
              <xsl:value-of select="format-number(sum(budinformasjon/budbelop), '0')"/>
              <xsl:text>&#x20;NOK</xsl:text>
            </div>
            <div class="celle" style="min-width:120px;">
  ...
  <xsl:template name="finansiellInformasjon">
    <div class="hovedseksjon">
      <xsl:call-template name="seksjon">
        <xsl:with-param name="tittel" select="'FinansiellInformasjon'"/>
      </xsl:call-template>
      
      <div class="tabell innhold">
        <div class="kropp">
          <div class="rad headerrad">
            <div class="celle">Fellesgjeld</div>
            <div class="celle">Felleskostnader</div>
            <div class="celle">Utleiemulighet</div>
          </div>
          <div class="rad">
            <div class="celle kol1">
              <xsl:value-of select="format-number(sum(finansiellInformasjon/fellesgjeld), '0')"/>
              <xsl:text>&#x20;NOK</xsl:text>
            </div>
            <div class="celle kol1">
              <xsl:value-of select="format-number(sum(finansiellInformasjon/felleskostnader), '0')"/>
              <xsl:text>&#x20;NOK</xsl:text>
            </div>
            <div class="celle kol1">
              <xsl:call-template name="yesNo">
                <xsl:with-param name="booleanValue" select="finansiellInformasjon/utleiemulighet"/>
              </xsl:call-template>
            </div>
          </div>
        </div>
  ...
  <xsl:template name="salgsobjektseksjon">
    <div class="hovedseksjon">
      <xsl:call-template name="seksjon">
  ...
  <xsl:template name="salgsobjekt">
    ...
    <div class="innhold">
      ...
      <xsl:if test="$salgsobjekt/finansiellInformasjon">
        <xsl:call-template name="finansiellInformasjon" />
      </xsl:if>
    </div>
  ...
  <xsl:template name="type">
    <xsl:if test="FinansieringsbekreftelseForespoersel">
      <xsl:text>Finansieringsbekreftelse fra megler</xsl:text>
    </xsl:if>
    <xsl:if test="finansieringsbekreftelseAvsluttet">
      <xsl:text>Budgivning avslutet</xsl:text>
    </xsl:if>
    <xsl:if test="finansieringsbekreftelseAvsluttetForKjoepere">
      <xsl:text>Budgivning avslutet, bud godkjent</xsl:text>
    </xsl:if>
  </xsl:template>
