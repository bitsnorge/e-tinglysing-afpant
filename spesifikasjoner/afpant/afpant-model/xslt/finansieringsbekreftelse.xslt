...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    ...
    <html>
      ...
      <body>
        <div id="container">
          ...
          <div id="body">
            <xsl:apply-templates select="finansieringsbekreftelseRequest"/>
            <xsl:apply-templates select="finansieringsbekreftelseAvslutet"/>
            <xsl:apply-templates select="finansieringsbekreftelseAvslutetForKjoepere"/>
          </div>
        </div>
  ...
  <xsl:template name="overskrift">
    <xsl:if test="finansieringsbekreftelseRequest">
      <xsl:text>Finansieringsbekreftelse</xsl:text>
    </xsl:if>
    <xsl:if test="finansieringsbekreftelseAvslutetForKjoepere">
      <xsl:text>FinansieringsbekreftelseAvslutetForKjoepere</xsl:text>
    </xsl:if>
    <xsl:if test="finansieringsbekreftelseAvslutet">
      <xsl:text>FinansieringsbekreftelseAvslutet</xsl:text>
    </xsl:if>
  </xsl:template>
  
  <xsl:template match="/finansieringsbekreftelseRequest">
    <xsl:call-template name="finansieringsbekreftelseRequest-template"/>
  </xsl:template>
  
  <xsl:template match="/finansieringsbekreftelseAvslutet">
    <xsl:call-template name="finansieringsbekreftelseAvslutet-template"/>
  </xsl:template>
  
  <xsl:template match="/finansieringsbekreftelseAvslutetForKjoepere">
    <xsl:call-template name="finansieringsbekreftelseAvslutetForKjoepere-template"/>
  </xsl:template>
  
  <xsl:template name="finansieringsbekreftelseRequest-template">
  ...
  <xsl:template name="finansieringsbekreftelseAvslutet-template">
  ...
  <xsl:template name="finansieringsbekreftelseAvslutetForKjoepere-template">
    <xsl:call-template name="annen"/>
  ...
  <xsl:template name="type">
    <xsl:if test="finansieringsbekreftelseRequest">
      <xsl:text>Finansieringsbekreftelse från megler</xsl:text>
    </xsl:if>
    <xsl:if test="finansieringsbekreftelseAvslutet">
