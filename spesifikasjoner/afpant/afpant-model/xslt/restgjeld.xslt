...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  ...
  <xsl:template name="aksjeleilighet">
    ...
    <xsl:if test="$aksjeleilighet/aksjeinformasjon">
      <div class="tabell innhold">
        <div class="kropp">
          <h4 class="h3">Aksjeinformasjon</h4>
          <xsl:if test="$aksjeleilighet/aksjeinformasjon/akjsenummerFra">
            <div>
              <span>Aksjenummer fra: </span>
              <xsl:value-of select="$aksjeleilighet/aksjeinformasjon/akjsenummerFra"/>
            </div>
          </xsl:if>
          <xsl:if test="$aksjeleilighet/aksjeinformasjon/akjsenummerTil">
            <div>
              <span>Aksjenummer til: </span>
              <xsl:value-of select="$aksjeleilighet/aksjeinformasjon/akjsenummerTil"/>
            </div>
          </xsl:if>
          <xsl:if test="$aksjeleilighet/aksjeinformasjon/paalydende">
            <div>
              <span>Pålydende: </span>
          ...
          <xsl:if test="$aksjeleilighet/aksjeinformasjon/antall">
            <div>
              <span>Antall aksjer: </span>
              <xsl:value-of select="$aksjeleilighet/aksjeinformasjon/antall"/>
            </div>
          </xsl:if></div>
      </div>
    </xsl:if>
